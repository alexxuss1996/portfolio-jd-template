...
let preprocessor = 'scss', // Preprocessor (sass, scss)
  ...
  buildDir = 'dist', // Build directory for deploy without «/» at the end
...
exports.build = series(cleandist, styles, scripts, images, buildcopyassets, htmlminify);
